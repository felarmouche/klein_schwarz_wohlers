...
const uspItems = [
  {
    ...
    text: "Unsere Partnerschaft besteht seit dem 1.1.2003. Wir sind im Rahmen unserer zivilrechtlichen Ausrichtung hauptsächlich für Versicherer auf dem Gebiet des allgemeinen und besonderen Haftpflichtrechts und des Versicherungsrechts tätig. Unser Schwerpunkt liegt dabei im Bereich des Verkehrsrechts. Neben diesem Schwerpunkt befassen wir uns aber selbstverständlich auch mit anderen Haftpflichttatbeständen, dem Sachversicherungsrecht und dem Personenschadensrecht. Weiter führen wir Versicherungsregresse durch.",
  },
  {
